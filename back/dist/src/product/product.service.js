...
let ProductService = class ProductService {
    ...
    async update(id, data) {
        return this.prisma.product.update({
            ...
            data: {
                ...data,
                slug: (0, generate_slug_1.generateSlug)(data.name),
            },
        });
    }
    async create() {
    ...
    async findProduct(filter, errorMessage) {
    ...
    getSortOption(sort) {
        if (sort === get_all_products_dto_1.EnumProductSort.LOW_PRICE)
            return { price: 'asc' };
        if (sort === get_all_products_dto_1.EnumProductSort.HIGH_PRICE)
            return { price: 'desc' };
        if (sort === get_all_products_dto_1.EnumProductSort.OLDEST)
